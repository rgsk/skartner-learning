...
import SimpleLatex from "@/components/Shared/SimpleLatex";
    ...
    <Container>
      ...
      <Problem>
        ...
        <Section>
          ...
          <Paragraph>
            <SimpleLatex expr="3 \rightarrow 10 \rightarrow 5 \rightarrow 16 \rightarrow 8 \rightarrow 4 \rightarrow 2 \rightarrow 1" />
          </Paragraph>
          <Paragraph>
